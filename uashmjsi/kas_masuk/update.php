<?php
    ...
    if(isset($_POST['Submit'])) {
        ...
        $sql = "UPDATE tbl_mhs SET nama_mhs='$nama_mhs', nim_mhs='$nim_mhs', jabatan_id='$jabatan_id', ttl_mhs='$ttl_mhs' , email_mhs='$email_mhs' WHERE mhs_id = $mhs_id"; 
...
<div class="col-12" style="margin-top: 120px">
    ...
    <form action="update.php" method="POST">
        ...
        <div class="form-group">
            <input type="hidden" name="email_mhs" value="<?= $email_mhs ?>">
            <label for="mhs_id">Email</label>
            <input type="text" class="form-control" name="email_mhs" value="<?= $email_mhs ?>">
        </div>
